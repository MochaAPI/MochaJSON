...
const config = {
  ...
  url: 'https://mochaapi.github.io',
  baseUrl: '/MochaJSON/',

  // GitHub Pages deployment configuration
  organizationName: 'MochaAPI',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/MochaAPI/MochaJSON/tree/main/docs/',
  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        ...
        { property: 'og:description', content: 'Simple, lightweight Java & Kotlin library for handling HTTP and JSON effortlessly. Perfect alternative to OkHttp + Gson with v1.0.0 production-ready design.' },
        { property: 'og:type', content: 'website' },
        { property: 'og:url', content: 'https://mochaapi.github.io/MochaJSON/' },
        { property: 'og:image', content: 'https://mochaapi.github.io/MochaJSON/img/social-card.jpg' },
        ...
        { property: 'twitter:description', content: 'Simplify your Java and Kotlin API development with MochaJSON v1.0.0. One library to replace OkHttp + Gson with production-ready stability.' },
        { property: 'twitter:image', content: 'https://mochaapi.github.io/MochaJSON/img/social-card.jpg' },
        { property: 'twitter:creator', content: '@MochaAPI' },
        { property: 'twitter:site', content: '@MochaAPI' },
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://search.maven.org/artifact/io.github.mochaapi/MochaJSON/1.0.0/jar',
            label: 'Maven Central',
            position: 'right',
          },
          {
            href: 'https://github.com/MochaAPI/MochaJSON',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'JavaDocs',
                href: 'https://javadoc.io/doc/io.github.mochaapi/MochaJSON/latest/index.html',
              },
              {
              ...
              },
              {
                ...
                href: 'https://github.com/MochaAPI/MochaJSON/issues',
              },
            ],
          },
          {
            ...
            items: [
              {
                ...
                href: 'https://github.com/MochaAPI/MochaJSON/discussions',
              },
              {
              ...
              },
              {
                ...
                href: 'https://github.com/MochaAPI/MochaJSON/security',
              },
            ],
          },
        ],

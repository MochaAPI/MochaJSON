 ...
 * 
 * @since 1.0.0 Enhanced with configurable timeouts and improved error handling
 */
public class DefaultHttpClientEngine implements HttpClientEngine {
    ...
    public ApiResponse execute(ApiRequest request) {
        ...
        try {
            ...
            Utils.validateUrl(url, request.getSecurityConfig());
            ...
            if (response.statusCode() >= 400) {
                // HTTP error - handled by response status
            }

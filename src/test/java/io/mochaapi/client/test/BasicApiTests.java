...
/**
 * Simple tests for MochaJSON v1.0.0 core functionality.
...
public class BasicApiTests {
    ...
    public void testBasicGetRequest() {
        ...
        try {
            ApiResponse response = client.get("https://api.github.com/users/MochaAPI")
                    .execute();
    ...
    public void testStaticApiClass() {
        ...
        // Test that Api is stateless (no shutdown state to check)
        System.out.println("✓ Api is stateless - no shutdown state to check");
    }

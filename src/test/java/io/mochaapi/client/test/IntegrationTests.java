...
/**
 * Simple integration tests for MochaJSON v1.0.0.
    ...
    public void testPostWithJsonBody() {
        ...
        try {
            ...
            ApiResponse response = client.post(BASE_URL + "/post")
                    ...
                    .header("User-Agent", "MochaJSON-Test/1.0.0")
                    .body(requestData)
                    .execute();
            
            assertNotNull(response);
            // Accept any response code for network resilience, just ensure we got a response
            System.out.println("Response code received: " + response.code());
    ...
    public void testPutRequest() {
        ...
        try {
            Map<String, Object> updateData = Map.of(
                "id", 1,
                "title", "Updated Title",
                "content", "Updated content for v1.0.0",
